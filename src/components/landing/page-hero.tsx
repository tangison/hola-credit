...
export function PageHero({ eyebrow, title, lead }: PageHeroProps) {
  return (
    <section className="border-b border-sand-300 bg-sand-50 pb-14 pt-36 lg:pb-20 lg:pt-44">
      <div className="mx-auto max-w-6xl px-5 sm:px-8">
        <Reveal>
          <p className="text-[11px] font-bold uppercase tracking-[0.22em] text-teal-500">{eyebrow}</p>
