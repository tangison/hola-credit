    ...
    <div className="flex min-h-screen flex-col bg-sand-50 text-ink">
      ...
      <main id="main-content" className="flex flex-1 items-center">
        <div className="mx-auto w-full max-w-6xl px-5 py-32 text-center sm:px-8">
          <p className="text-[11px] font-bold uppercase tracking-[0.22em] text-teal-500">404</p>
          <h1 className="mx-auto mt-5 max-w-xl font-serif text-4xl font-semibold leading-[1.08] tracking-tight text-balance text-ink sm:text-5xl">
            This page did not make it through underwriting.
          </h1>
          <p className="mx-auto mt-6 max-w-md text-[16.5px] leading-relaxed text-ink/65">
