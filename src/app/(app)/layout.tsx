    ...
    <div className="min-h-screen flex bg-sand">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="lg:hidden sticky top-0 z-40 bg-white border-b border-sand-300 px-4 h-14 flex items-center justify-between">
          ...
          {/* Symbol mark only on mobile — pure paths, always renders */}
          <Link href="/" aria-label="Hola Credit home" className="inline-flex items-center gap-1.5">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96 64" className="h-6 w-9" aria-hidden="true">
            ...
            <span className="font-sans text-sm font-semibold tracking-tight text-ink whitespace-nowrap">hola credit</span>
          </Link>
